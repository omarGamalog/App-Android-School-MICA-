...
public class FirestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firest);
...
B.setOnClickListener(new View.OnClickListener() {
    @Override
    public void onClick(View v) {
        startActivity(new Intent(getApplication(),UI.class));
    }
});
...
//        fAuth= FirebaseAuth.getInstance();
        B.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(email.equals("Mica@gmail.com")&&pass.equals("Mica123")){

                    startActivity(new Intent(getApplication(),ou.class));
